...
module Clockwork
  ...
  every(1.second, 'ib.trader', :if => lambda { |t| (([2,5,8,11,14,17,20,23,26,29,32,35,38,41,44,47,50,53,56,59].include? t.min) && t.sec == 54) }, :thread => true) if ENV["backtrader_version"] == "3min"
