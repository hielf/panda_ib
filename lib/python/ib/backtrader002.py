...
reg_buy_open = joblib.load('reg_buy_open2.pkl')
reg_buy_break = joblib.load('reg_buy_break2.pkl')
reg_sale_open = joblib.load('reg_sale_open2.pkl')
reg_sale_break = joblib.load('reg_sale_break2.pkl')
