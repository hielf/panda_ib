...
class kam999(bt.Strategy):
    ...
    def next(self):
        ...
        #2040
        tr_condition1 = self.datatr[0] in range(0,20) and self.data.tr_10T[0] in range(21,40)
        tr_condition2 = self.datatr[0] in range(20,40) and self.data.tr_10T[0] in range(40,80)
